...
class SentimentAnalyzer:
    ...
    def _analyze_text(self, text):
        ...
        try:
            ...
            # 构建带有原文上下文的提示
            prompt = f'''假设你是一个发布微博原文的博主，请你判断以下微博评论的情感态度，请注意可能会有阴阳怪气、讽刺、或者谐音骂人的情况，
            请仔细判断，并且注意不把表情包、链接和[]中的内容纳入判断依据。反讽、阴阳怪气、谐音骂人属于消极的态度，注意即使是包含“666”“爱你”的评论也有可能是反讽，属于消极态度。
...
2 表示消极态度
1 表示中性态度
每一条评论对应返回一个数字 0、1 或 2,不要包含任何其他内容'''
